            ...
            <div class="md:flex no-wrap md:-mx-2 ">
                ...
                <div class="w-full md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white p-3 border-t-4 border-green-400">
                        ...
                        <h3 class="text-gray-600 font-lg text-semibold leading-6">{{unitName}}</h3>
                        ...
                        <ul
                            ...
                            <li class="flex items-center py-3">
                                ...
                                <span class="ml-auto"><span
                                        class="bg-green-500 py-1 px-2 rounded text-white text-sm">{{roleName}}</span></span>
                            </li>
                            <li class="flex items-center py-3">
                        ...
                        <div class="text-gray-700">
                            <div class="grid md:grid-cols-2 text-sm">
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="px-4 py-2">{{userPhoneNumber}}</div>
                                </div>
                                <div class="grid grid-cols-2">
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="px-4 py-2">
                                        <a class="text-blue-800" href="mailto:jane@example.com">{{userEmail}}</a>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2">
