    ...
    <nav
      ...
      <div class="w-16 h-16 flex justify-center items-center text-gray-600 sm:hidden">
        ...
        <transition enter-active-class="transition duration-200 ease-in-out transform"
          enter-class="-translate-x-full opacity-0" leave-active-class="transition duration-200 ease-in-out transform"
              ...
              <div class="py-6 w-full min-h-full bg-gray-700">
                ...
                <div class="mt-4">
                  ...
                  <a v-for="i in Array(14).keys()" href="#"
                    ...
                    <div>
                      <svg class="fill-current w-6 h-6 hover:block" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
      ...
      <div class="w-16 h-16 flex justify-center items-center text-gray-600 border-l border-gray-600">
        ...
        <transition enter-active-class="transition duration-200 ease-in-out transform" enter-class="translate-x-full"
          leave-active-class="transition duration-200 ease-in-out transform" leave-to-class="translate-x-full">
          <div v-show="isNotificationsOpen" class="pt-16 fixed inset-0 h-full">
            <div ref="notifications" class="mt-16 absolute right-0 inset-y-0 w-full max-w-sm overflow-y-auto">
              <div class="relative z-40 py-2 text-gray-700 bg-white border border-yellow-400 shadow-lg">
                <a href="#" class="block px-4 py-2 hover:text-gray-100 hover:bg-gray-800" v-for="i in Array(5).keys()">
                  Notification {{ i + 1 }}
                </a>
              </div>
            </div>
