<template>
    ...
    <div v-if="showModalUpdateOne" class="opacity-25 fixed inset-0 z-40 bg-black"></div>
</template>
...
export default {
    ...
    emits: ["emtToggleModalUpdateOne"],
    props: ['showModalUpdateOne', 'idItem'],
    methods: {
        toggleModalUpdateOne() {
            this.$emit('emtToggleModalUpdateOne')
        }
    }
}
</script>